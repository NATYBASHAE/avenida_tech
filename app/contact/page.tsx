			...
			<section className="py-24 relative overflow-hidden">
				...
				<div className="max-w-[1280px] mx-auto px-6 lg:px-8 relative z-10">
					<div className="text-center mb-16">
						...
						>
							Speak with Avenida Technologies about consultation, installation,
							maintenance, or commercial display planning.
						</motion.p>
					</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
						...
						<div className="flex flex-col gap-6">
							...
							>
								...
								<div>
									...
									<p className="text-muted text-sm mb-2">
										Fastest way to reach our technical team.
									</p>
									<a
										href="https://wa.me/251967009542"
										target="_blank"
										rel="noreferrer noopener"
										className="text-[#25D366] font-mono hover:underline"
									>
										+251 96 700 9542
									</a>
								</div>
							...
							>
								...
								<div>
									...
									<p className="text-muted text-sm mb-2">
										Send us your project RFPs.
									</p>
									<a
										href="mailto:info@avenidatechs.com"
										className="text-primary font-mono hover:underline"
									>
										info@avenidatechs.com
									</a>
								</div>
							</motion.div>
						...
						>
							...
							<h3 className="font-heading text-2xl font-bold mb-6 text-white">
